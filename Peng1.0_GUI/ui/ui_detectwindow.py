...
class Ui_detectWindow(object):
    def setupUi(self, detectWindow):
        ...
        icon = QIcon()
        icon.addFile(u":/resource/10125_icons/shell32_35.ico", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        icon1 = QIcon()
        icon1.addFile(u":/resource/mine/newwindow.ico", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        icon2 = QIcon()
        icon2.addFile(u":/resource/mine/openfile.ico", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.actionOpen_File.setIcon(icon2)
        self.actionSave = QAction(detectWindow)
        self.actionSave.setObjectName(u"actionSave")
        icon3 = QIcon()
        icon3.addFile(u":/resource/mine/save.ico", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.actionSave.setIcon(icon3)
        self.actionSave_As = QAction(detectWindow)
        self.actionSave_As.setObjectName(u"actionSave_As")
        icon4 = QIcon()
        icon4.addFile(u":/resource/mine/saveas.ico", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.actionSave_As.setIcon(icon4)
        self.actionPrint = QAction(detectWindow)
        self.actionPrint.setObjectName(u"actionPrint")
        icon5 = QIcon()
        icon5.addFile(u":/resource/mine/print.ico", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        icon8 = QIcon()
        icon8.addFile(u":/resource/10125_icons/imageres_5315.ico", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.actionUndo.setIcon(icon8)
        self.actionRedo = QAction(detectWindow)
        self.actionRedo.setObjectName(u"actionRedo")
        icon9 = QIcon()
        icon9.addFile(u":/resource/10125_icons/imageres_5311.ico", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.actionRedo.setIcon(icon9)
        self.actionCut = QAction(detectWindow)
        self.actionCut.setObjectName(u"actionCut")
        icon10 = QIcon()
        icon10.addFile(u":/resource/10125_icons/shell32_16762.ico", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.actionCut.setIcon(icon10)
        self.actionCopy = QAction(detectWindow)
        self.actionCopy.setObjectName(u"actionCopy")
        icon11 = QIcon()
        icon11.addFile(u":/resource/10125_icons/shell32_243.ico", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.actionCopy.setIcon(icon11)
        self.actionPaste = QAction(detectWindow)
        self.actionPaste.setObjectName(u"actionPaste")
        icon12 = QIcon()
        icon12.addFile(u":/resource/10125_icons/shell32_16763.ico", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        icon13 = QIcon()
        icon13.addFile(u":/resource/mine/delete.ico", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        self.actionDetection_Current_Image = QAction(detectWindow)
        self.actionDetection_Current_Image.setObjectName(u"actionDetection_Current_Image")
        self.actionDetection_Current_Image.setCheckable(True)
        self.actionDetection_Current_Image.setChecked(True)
        self.actionDetection_Entire_Batch = QAction(detectWindow)
        self.actionDetection_Entire_Batch.setObjectName(u"actionDetection_Entire_Batch")
        self.actionDetection_Entire_Batch.setCheckable(True)
        self.actionDetection_Per_Image = QAction(detectWindow)
        self.actionDetection_Per_Image.setObjectName(u"actionDetection_Per_Image")
        self.actionDetection_Per_Image.setCheckable(True)
        self.actionDetection_Per_Image.setChecked(True)
        self.actionDetection_Continuous = QAction(detectWindow)
        self.actionDetection_Continuous.setObjectName(u"actionDetection_Continuous")
        self.actionDetection_Continuous.setCheckable(True)
        self.actionLinear_Single_Image = QAction(detectWindow)
        self.actionLinear_Single_Image.setObjectName(u"actionLinear_Single_Image")
        self.actionLinear_Single_Image.setCheckable(True)
        self.actionLinear_Single_Image.setChecked(True)
        self.actionLinear_Image_Series = QAction(detectWindow)
        self.actionLinear_Image_Series.setObjectName(u"actionLinear_Image_Series")
        self.actionLinear_Image_Series.setCheckable(True)
        ...
        icon15 = QIcon()
        icon15.addFile(u":/resource/mine/refresh.ico", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        icon16 = QIcon()
        icon16.addFile(u":/resource/mine/fullscreen.ico", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        icon17 = QIcon()
        icon17.addFile(u":/resource/mine/restore.ico", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.actionRestore.setIcon(icon17)
        self.actionZoom_In = QAction(detectWindow)
        self.actionZoom_In.setObjectName(u"actionZoom_In")
        icon18 = QIcon()
        icon18.addFile(u":/resource/mine/zoomin.ico", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.actionZoom_In.setIcon(icon18)
        self.actionZoom_Out = QAction(detectWindow)
        self.actionZoom_Out.setObjectName(u"actionZoom_Out")
        icon19 = QIcon()
        icon19.addFile(u":/resource/mine/zoomout.ico", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        icon21 = QIcon()
        icon21.addFile(u":/resource/mine/gonext.ico", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        icon22 = QIcon()
        icon22.addFile(u":/resource/mine/goprevious.ico", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        icon23 = QIcon()
        icon23.addFile(u":/resource/mine/exportpdf.ico", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        self.menuDetection = QMenu(self.menubar)
        self.menuDetection.setObjectName(u"menuDetection")
        self.menuDetection_Scope = QMenu(self.menuDetection)
        self.menuDetection_Scope.setObjectName(u"menuDetection_Scope")
        self.menuDetection_Numbering = QMenu(self.menuDetection)
        self.menuDetection_Numbering.setObjectName(u"menuDetection_Numbering")
        self.menuLinear = QMenu(self.menubar)
        self.menuLinear.setObjectName(u"menuLinear")
        ...
        self.menuToolBar.setCursor(QCursor(Qt.CursorShape.ArrowCursor))
        ...
        detectWindow.addToolBar(Qt.ToolBarArea.TopToolBarArea, self.menuToolBar)
        self.dockWidget = QDockWidget(detectWindow)
        self.dockWidget.setObjectName(u"dockWidget")
        self.dockWidgetContents = QWidget()
        self.dockWidgetContents.setObjectName(u"dockWidgetContents")
        self.dockWidget.setWidget(self.dockWidgetContents)
        detectWindow.addDockWidget(Qt.DockWidgetArea.LeftDockWidgetArea, self.dockWidget)

        self.menubar.addAction(self.menuFile.menuAction())
        self.menubar.addAction(self.menuEdit.menuAction())
        self.menubar.addAction(self.menuView.menuAction())
        self.menubar.addAction(self.menuDetection.menuAction())
        self.menubar.addAction(self.menuLinear.menuAction())
        ...
        self.menuDetection.addAction(self.menuDetection_Scope.menuAction())
        self.menuDetection.addAction(self.menuDetection_Numbering.menuAction())
        self.menuDetection_Scope.addAction(self.actionDetection_Current_Image)
        self.menuDetection_Scope.addAction(self.actionDetection_Entire_Batch)
        self.menuDetection_Numbering.addAction(self.actionDetection_Per_Image)
        self.menuDetection_Numbering.addAction(self.actionDetection_Continuous)
        self.menuLinear.addAction(self.actionLinear_Single_Image)
        self.menuLinear.addAction(self.actionLinear_Image_Series)
    ...
    def retranslateUi(self, detectWindow):
        ...
        self.actionDetection_Current_Image.setText(QCoreApplication.translate("detectWindow", u"Current Image", None))
        self.actionDetection_Entire_Batch.setText(QCoreApplication.translate("detectWindow", u"Entire Batch", None))
        self.actionDetection_Per_Image.setText(QCoreApplication.translate("detectWindow", u"Reset for Each Image", None))
        self.actionDetection_Continuous.setText(QCoreApplication.translate("detectWindow", u"Continue Across Batch", None))
        self.actionLinear_Single_Image.setText(QCoreApplication.translate("detectWindow", u"Single Image", None))
        self.actionLinear_Image_Series.setText(QCoreApplication.translate("detectWindow", u"Image Series", None))
        ...
        self.menuDetection.setTitle(QCoreApplication.translate("detectWindow", u"Detection", None))
        self.menuDetection_Scope.setTitle(QCoreApplication.translate("detectWindow", u"Detection Scope", None))
        self.menuDetection_Numbering.setTitle(QCoreApplication.translate("detectWindow", u"Numbering", None))
        self.menuLinear.setTitle(QCoreApplication.translate("detectWindow", u"Linear", None))
